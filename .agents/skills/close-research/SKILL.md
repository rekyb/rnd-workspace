...
The body of this skill lives in `.claude/commands/close-research.md`. Read that file and follow it exactly. It is the single source of truth for this workflow and the only copy kept current.
