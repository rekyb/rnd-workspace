...
The body of this skill lives in `.claude/commands/save-session.md`. Read that file and follow it exactly. It is the single source of truth for this workflow and the only copy kept current.
